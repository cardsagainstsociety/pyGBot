...
['Make a haiku: ____ / ____ / ____',2,3],
['____: good to the last drop.',0,1],
['____: kid-tested, mother-approved.',0,1],
['____? There\'s an app for that.',0,1],
['I got 99 problems but ____ ain\'t one.',0,1],
['Maybe she\'s born with it. Maybe it\'s ____.', 0, 1],
['What\'s the next Happy Meal toy?',0,1],
['Anthropologists have recently discovered a primitive tribe that worships ____.',0,1],
['It\'s a pity that kids these days are all getting involved with ____.',0,1],
['What ended my last relationship?',0,1],
['MTV\'s new reality show features eight washed-up celebrities living with ____.',0,1],
['I\'m sorry, Professor, but I couldn\'t complete my homework because of ____.',0,1],
['This is the way the world ends \\ This is the way the world ends \\ Not with a bang but with ____.',0,1],
['TSA guidelines now prohibit ____ on airplanes.',0,1],
['____. That\'s how I want to die.',0,1],
['____ is a slippery slope that leads to ____.',1,2],
['Dear Abby, I\'m having some problems with ____ and would like your advice.',0,1],
['In 1,000 years, when paper money is but a distant memory, ____ will be our currency.',0,1],
['In M. Night Syamalan\'s new movie, Bruce Willis discovers that ____ had really been ____ all along.',1,2],
['A romantic, candlelit dinner would be incomplete without ____.',0,1],
['Next from J. K. Rowling: Harry Potter and the Chamber of ____.',0,1],
['In a world ravaged by ____, our only solace is ____.',1,2],
['In L.A. County Jail, word is you can trade 200 cigarettes for ____.',0,1],
['Coming to Broadway this season, ____: The Musical.',0,1],
['While the United States raced the Soviet Union to the moon, the Mexican government funneled millions of pesos into research on ____.',0,1],
['After the earthquake, Sean Penn brought ____ to the people of Haiti.',0,1],
['Next on ESPN2, the World Series of ____.',0,1],
['Step 1: ____. Step 2: ____. Step 3: Profit.',1,2],
['Rumor has it that Vladimir Putin\'s favorite dish is ____ stuffed with ____.',1,2],
['When Pharaoh remained unmoved, Moses called down a Plague of ____.',0,1],
['I never truly understood ____ until I encountered ____.',1,2],
['What\'s Teach for America using to inspire inner city students to succeed?',0,1],
['Life for American Indians was forever changed when the White Man introduced them to ____.',0,1],
['I do not know with what weapons World War III will be fought, but World War IV will be fought with ____.',0,1],
['Why do I hurt all over?',0,1],
['What am I giving up for Lent?',0,1],
['in Michael Jackson\'s final moments, he thought about ____.',0,1],
['In an attempt to reach a wider audience, the Smithsonian Museum of Natural History has opened an exhibit on ____.',0,1],
['____ + ____ = ____.',2,3],
['What never fails to liven up the party?',0,1],
['What\'s the new fad diet?',0,1],
]
